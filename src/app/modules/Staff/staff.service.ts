...
const addStaff = async (ownerId: string, payload: any) => {
  ...
  if (!salonOwner) {
    throw new ApiError(StatusCodes.FORBIDDEN, 'Only salon owners can add staff');
  }
  ...
  if (salon.ownerId !== salonOwner.id) {
    throw new ApiError(StatusCodes.FORBIDDEN, 'You can only add staff to your own salons');
  }
...
const updateStaff = async (ownerId: string, staffId: string, payload: any) => {
  ...
  if (!salonOwner) {
    throw new ApiError(StatusCodes.FORBIDDEN, 'Only salon owners can update staff');
  }
...
const removeStaff = async (ownerId: string, staffId: string) => {
  ...
  if (!salonOwner) {
    throw new ApiError(StatusCodes.FORBIDDEN, 'Only salon owners can remove staff');
  }
  ...
  if (staff.salon.ownerId !== salonOwner.id) {
    throw new ApiError(StatusCodes.FORBIDDEN, 'You can only remove your own staff');
  }
